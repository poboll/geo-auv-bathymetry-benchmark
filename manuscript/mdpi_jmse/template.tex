...
\begin{table}[H]
	...
	\begin{tabular}{@{}p{0.23\linewidth}p{0.24\linewidth}p{0.24\linewidth}p{0.17\linewidth}@{}}
		\toprule[1bp]
...
\begin{table}[H]
	...
	\scriptsize
	\renewcommand{\arraystretch}{1.12}
	\begin{tabular}{@{}p{0.17\linewidth}p{0.19\linewidth}p{0.32\linewidth}p{0.18\linewidth}@{}}
		\toprule[1bp]
...
\begin{table}[H]
	...
	\begin{tabular}{@{}p{0.21\linewidth}p{0.23\linewidth}p{0.24\linewidth}p{0.18\linewidth}@{}}
		\toprule[1bp]
