...
| 2 | `gebco_tid_grid` | verified_manual_fallback | GEBCO Type Identifier (TID) Grid |  |
| 3 | `dartnell2026southerncascadia` | verified_doi_redirects | https://cmgds.marine.usgs.gov/data-releases/datarelease/10.5066-P9C5DBMR/ |  |
...
| 7 | `shi2020data` | verified_crossref | A Data-Driven Intermittent Online Coverage Path Planning Method for AUV-Based Bathymetric Mapping |  |
| 8 | `yordanova2020coverage` | verified_doi_redirects | https://ieeexplore.ieee.org/document/9121686/ |  |
...
| 21 | `zhang2023rbpf` | verified_doi_redirects | https://linkinghub.elsevier.com/retrieve/pii/S0029801823023909 |  |
...
| 23 | `zhang2024ambiguouspf` | verified_crossref | A robust particle filter for ambiguous updates of underwater terrain-aided navigation |  |
...
| 35 | `mu2025coverage` | verified_doi_redirects | https://www.frontiersin.org/articles/10.3389/fmars.2024.1483122/full |  |
| 36 | `yao2021coverage` | verified_crossref | AUV path planning for coverage search of static target in ocean environment |  |
| 37 | `hadi2022drlcpp` | verified_crossref | Deep reinforcement learning for adaptive path planning and control of an autonomous underwater vehicle |  |
...
| 45 | `zhang2021path` | verified_crossref | Path planning and obstacle avoidance for AUV: A review |  |
